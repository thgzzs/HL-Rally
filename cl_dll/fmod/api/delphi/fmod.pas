...
function FSOUND_Stream_GetTagField(Stream: PFSoundStream; Num: Integer; var TagType: TFSoundTagFieldType; var Name: PChar; var Value: Pointer; Length: Integer): ByteBool; {$IFDEF LINUX} cdecl {$ELSE} stdcall {$ENDIF};
...
function FSOUND_GetNumHardwareChannels; external FMOD_DLL {$IFDEF MSWINDOWS} name '_FSOUND_GetNumHardwareChannels@0' {$ENDIF};
...
function FSOUND_CD_Eject; external FMOD_DLL {$IFDEF MSWINDOWS} name '_FSOUND_CD_Eject@4' {$ENDIF};
