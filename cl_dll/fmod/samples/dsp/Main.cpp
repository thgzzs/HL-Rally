...
*/
void * F_CALLBACKAPI DSP_ReverbCallback(void *originalbuffer, void *newbuffer, int length, int param)
{
    ...
    */
    if (tap->historyoffset + length > tap->historylen)
    {
        ...
        */
        ...
        {
            dest[count] = (signed short)((int)src[count] < -32768 ? -32768 : (int)src[count] > 32767 ? 32767 : src[count]);
        }
