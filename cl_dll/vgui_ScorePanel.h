...
typedef enum scorepanel_columns {
	COLUMN_TRACKER = 0,
	COLUMN_NAME,
	COLUMN_CAR,
	COLUMN_POSITION,
...
// Residual defines
//#define COLUMN_CLASS	COLUMN_POSITION
//#define COLUMN_KILLS	COLUMN_SCORE
//#define COLUMN_DEATHS	COLUMN_RACETIME
//#define COLUMN_BLANK	COLUMN_VOICE
// SaRcaZm - V4 - End

using namespace vgui;

class TmpTextImage : public TextImage {
public:
	TmpTextImage (void) : TextImage ("")
	{
	}
};
...
public:
	...
	TmpTextImage *GetImage(int image)
	{
		return &_image[image];
	}
...
public:
	...
	// SaRcaZm - V4 - Start
	void setCheckeredBg (bool checked);
	// SaRcaZm - V4 - End
