...
public:
	...
	// FragMented! Updated by Creme
	bool TerrainTrace ( float *n, float *vOfs, float *vUp, bool interior, float *endpos);

	// All the stuff from SetupTransform moved to a new member
	virtual void CStudioModelRenderer::StudioRallyRender( void );
...
public:
	...
	// FragMented!
	cvar_t			*m_pCvarRotatefx;
	cvar_t			*m_pCvarChromefx; // FragMented - RC7
