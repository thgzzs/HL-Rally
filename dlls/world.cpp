...
void CWorld :: Precache( void )
{
	...
	CVAR_SET_STRING("sv_stepsize", "24"); // FragMented! - this being high removes vertical evil edge
#else
	CVAR_SET_STRING("sv_gravity", "384"); // 32ft/sec
	CVAR_SET_STRING("sv_stepsize", "32"); // FragMented! - this being high removes vertical evil edge
#endif
...
/*	else if ( FStrEq(pkvd->szKeyName, "defaultteam") )
	...
	// SaRcaZm - V6 - Start
	else if ( FStrEq(pkvd->szKeyName, "starttime") )
	{
		iStartTime = atoi (pkvd->szValue);
	}
	// SaRcaZm - V6 - End
	// SaRcaZm - V7 - Start
	else if (FStrEq(pkvd->szKeyName, "timeperlap"))
	{
		iTimePerLap = atoi (pkvd->szValue);
	}
	// SaRcaZm - V7 - End
