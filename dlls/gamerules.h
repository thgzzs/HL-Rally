...
protected:
	...
	// SaRcaZm - V6 - Start
	void SendTextFileToClient (edict_t *client, char *aFileList, int length, int gmsgNum);
	// SaRcaZm - V6 - End
};
