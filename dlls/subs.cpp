...
LINK_ENTITY_TO_CLASS(info_player_deathmatch_reverse,CBaseDMStart);
LINK_ENTITY_TO_CLASS(info_player_start_reverse,CBaseDMStart);

LINK_ENTITY_TO_CLASS(info_player_respawn,CBaseDMRespawn);
// SaRcaZm - V6 - End
// SaRcaZm - V7 - Start
LINK_ENTITY_TO_CLASS(info_vgui_start, CBaseDMStart);
// SaRcaZm - V7 - End
