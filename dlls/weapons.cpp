...
void W_Precache(void)
{
	...
	/*
	// custom items...
	PRECACHE_MODEL ("sprites/r_rocks.spr"); //FragMented

	PRECACHE_MODEL ("sprites/r_dirt.spr"); //FragMented
	PRECACHE_MODEL ("sprites/r_sand.spr"); //FragMented
	PRECACHE_MODEL ("sprites/r_snow.spr"); //FragMented

	PRECACHE_MODEL ("sprites/hp_bomb.spr"); //FragMented

	// SaRcaZm - V3 - Start
	// Why is this here?
	//PRECACHE_MODEL ("models/player/punto/punto.mdl"); // FragMented
	// SaRcaZm - V3 - End

	PRECACHE_SOUND ("voc/checkpoint.wav"); // FragMented
	PRECACHE_SOUND ("voc/nexttime.wav"); // FragMented
	PRECACHE_SOUND ("voc/lapcomplete.wav"); // FragMented

	PRECACHE_SOUND ("voc/warning30.wav"); // FragMented
	PRECACHE_SOUND ("voc/321.wav"); // FragMented

	PRECACHE_SOUND ("horn.wav");
	PRECACHE_SOUND ("backfire.wav");

	// SaRcaZm - Start
	PRECACHE_MODEL ("sprites/r_skid.spr");
	PRECACHE_MODEL ("sprites/r_shadow.spr");
	// SaRcaZm - End
	// SaRcaZm - V3 - Start
	PRECACHE_MODEL ("sprites/showroom_f.spr");
	// SaRcaZm - V3 - End
	*/
	int string;
	string = ALLOC_STRING (hlConst.szPrecache_Rocks);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Dirt);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Snow);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Bomb);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Checkpoint);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_NextTime);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_LapComplete);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Warning);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_321);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Horn);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Backfire);
	PRECACHE_SOUND ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Skid);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Shadow);
	PRECACHE_MODEL ((char *) STRING (string));

	string = ALLOC_STRING (hlConst.szPrecache_Showroom);
	PRECACHE_MODEL ((char *) STRING (string));
	// SaRcaZm - V5 - End

	// SaRcaZm - V6 - Start
	PRECACHE_MODEL ("sprites/r_skid_dirt.spr");
	PRECACHE_MODEL ("sprites/r_skid_sand.spr");
	PRECACHE_MODEL ("sprites/r_skid_snow.spr");
	// SaRcaZm - V6 - End
	// SaRcaZm - V7 - Start
	PRECACHE_MODEL ("sprites/r_grass.spr");
	PRECACHE_MODEL ("sprites/r_smoke.spr");
	PRECACHE_MODEL ("sprites/r_sand.spr");

	iLightningTexture = PRECACHE_MODEL( "sprites/lgtning.spr");
	// SaRcaZm - V7 - End
...
*/
	// FragMented
	UTIL_PrecacheOtherWeapon( "weapon_rallyhp" );
/*
	// glock
...
{ 
//	m_pPlayer->pev->viewmodel = 0; FragMented!
...
//	m_pPlayer->pev->viewmodel = iStringNull; FragMented!
	m_pPlayer->pev->weaponmodel = iStringNull;
	//m_pPlayer->pev->viewmodelindex = NULL; FragMented!
