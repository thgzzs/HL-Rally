...
#define VEC_HULL_MIN		Vector(-5,-5,-1 )
#define VEC_HULL_MAX		Vector( 5, 5, 1 )
#define VEC_HUMAN_HULL_MIN	Vector(-5,-5,-1 )
#define VEC_HUMAN_HULL_MAX	Vector( 5, 5, 1 )
#define VEC_HUMAN_HULL_DUCK	Vector( 0, 0, 0 )

#define VEC_VIEW			Vector( 0, 0, 28 )

#define VEC_DUCK_HULL_MIN	Vector(-1,-1,-1 )
#define VEC_DUCK_HULL_MAX	Vector( 1, 1, 1 )
